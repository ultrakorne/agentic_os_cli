...
description: |
    Use this skill when the user asks you to create, schedule, run, or inspect a local agent via the `aos` CLI — anything under `aos list/describe/schedule/ run/runs/refresh`. Also use it when writing scripts that live under `<aos_home>/agents/`
license: MIT
metadata:
    github-path: skills/aos
    github-ref: refs/tags/v0.1.1
    github-repo: https://github.com/ultrakorne/agentic_os_cli
    github-tree-sha: a45e4a062fa09b9135502107a3927cebbec969b3
name: aos
---
# aos
